from data_loader import load_data_with_label_name, tokenizer
...
def main():
    ...
    train_dataloader, eval_dataloader = load_data_with_label_name(task)
    config = AutoConfig.from_pretrained(checkpoint)
    config.num_classes=[2] * len(task)
